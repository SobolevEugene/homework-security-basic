...
@ResourceRole(name = "Access to departments", code = DepartmentsAccessRole.CODE, scope = "UI")
public interface DepartmentsAccessRole {
	String CODE = "departments-access-role";
